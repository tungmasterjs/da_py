...
# Form implementation generated from reading ui file 'barber.ui'
#
...
class Ui_barber_form(object):
    def setupUi(self, barber_form):
        barber_form.setObjectName("barber_form")
        barber_form.resize(451, 524)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/img/Barbershop/2.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        barber_form.setWindowIcon(icon)
        barber_form.setStyleSheet("QPushButton{\n"
"    padding: 10 0 10 0;\n"
"    border-radius: 20;\n"
...
"}")
        self.groupBox_2 = QtWidgets.QGroupBox(barber_form)
...
"}")
        ...
        self.luu_them_tho_btn = QtWidgets.QPushButton(self.groupBox_2)
        self.luu_them_tho_btn.setGeometry(QtCore.QRect(200, 360, 91, 41))
        font = QtGui.QFont()
        font.setFamily("Noto Sans")
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        self.luu_them_tho_btn.setFont(font)
        self.luu_them_tho_btn.setObjectName("luu_them_tho_btn")
        self.ket_thuc_them_tho_btn = QtWidgets.QPushButton(self.groupBox_2)
        self.ket_thuc_them_tho_btn.setGeometry(QtCore.QRect(310, 360, 101, 41))
        font = QtGui.QFont()
        font.setFamily("Noto Sans")
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        self.ket_thuc_them_tho_btn.setFont(font)
        self.ket_thuc_them_tho_btn.setObjectName("ket_thuc_them_tho_btn")
        self.widget_5 = QtWidgets.QWidget(barber_form)
...
"")
        ...
        self.label_15 = QtWidgets.QLabel(barber_form)
...
"border-bottom-right-radius: 10px;")
        ...
        self.retranslateUi(barber_form)
        QtCore.QMetaObject.connectSlotsByName(barber_form)
        barber_form.setTabOrder(self.ma_tho_edit, self.ten_tho_edit)
        barber_form.setTabOrder(self.ten_tho_edit, self.sdt_tho_edit)
        barber_form.setTabOrder(self.sdt_tho_edit, self.so_nam_kn_edit)
        barber_form.setTabOrder(self.so_nam_kn_edit, self.luu_them_tho_btn)
        barber_form.setTabOrder(self.luu_them_tho_btn, self.ket_thuc_them_tho_btn)

    def retranslateUi(self, barber_form):
        _translate = QtCore.QCoreApplication.translate
        barber_form.setWindowTitle(_translate("barber_form", "Thêm thợ"))
        self.label_2.setText(_translate("barber_form", "Mã thợ:"))
        self.label_3.setText(_translate("barber_form", "Tên thợ:"))
        self.label_4.setText(_translate("barber_form", "SĐT thợ:"))
        self.label_5.setText(_translate("barber_form", "Số năm KN:"))
        self.luu_them_tho_btn.setText(_translate("barber_form", "Lưu"))
        self.ket_thuc_them_tho_btn.setText(_translate("barber_form", "Kết thúc"))
        self.label_15.setText(_translate("barber_form", "THÊM THỢ"))
...
if __name__ == "__main__":
    ...
    barber_form = QtWidgets.QDialog()
    ui = Ui_barber_form()
    ui.setupUi(barber_form)
    barber_form.show()
    sys.exit(app.exec_())
